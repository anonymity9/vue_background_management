        ...
        <!--搜索与添加区域  -->
          ...
          <el-table :data="userlist" border stripe>
             ...
             <el-table-column label="操作" width="180px">
               <template slot-scope="scope">
                  <!-- 修改按钮 -->
                  <el-button type="primary" icon="el-icon-edit" size="mini" @click="showEdiDialog(scope.row.id)"></el-button>
                  <!-- 删除按钮 -->
    ...
    return{
      ...
      addFormRules: {
        ...
        password: [
          ...
          {min: 6, max: 15, message: '用户名长度在6至15个字符',trigger: 'blur' }
        ],
        email: [
        ...
        mobile: [
          {required: true, message:'请输入电话号码', trigger: 'blur'},{validator: checkMobile,
          trigger: 'blur'},
        ],
